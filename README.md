...
**Full‑stack Architect** with 14 years of experience Building AI-Powered Web Apps | React | GenAI | ML | Deep Learning scalable with React, Angular, Node.js, PHP,Python and MySQL.
...
- Backend: Node.js,Python, Express, PHP
- Databases: MySQL, PostgreSQL, MongoDB
- Tools & Practices: GitHub Actions, CI/CD, Docker, Agile

### 📌 Featured repositories

- [Python end to end](https://github.com/vikashask/python-all-in-one) – python-all-in-one
